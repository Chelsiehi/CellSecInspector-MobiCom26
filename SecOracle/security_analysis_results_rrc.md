...
{
  "vulnerability_detected": "Yes",
  "violated_requirements": [2, 6, 14, 36],
  "explanation": "After receiving RRCRelease with suspendConfig, the UE may autonomously reselect to another cell and acquire its broadcast system information. SIB1 in 5G and SIB2 in 4G are processed before AS security is established and therefore lack integrity and source authentication. A rogue base station can inject malicious system information containing an extremely restrictive access barring factor, such as barringFactor = 0. The UE locally enforces the advertised policy and refrains from initiating mobile-originated access, creating a stealthy denial-of-service condition while the UE appears camped on the cell.",
  "issue_classification": "Protocol Design Issue",
  "test_case": "Configure a rogue or controlled base station to advertise a stronger signal and broadcast SIB1 in 5G or SIB2 in 4G with the access barring factor set to 0. Verify that the UE decodes the barring information but does not initiate RRC connection establishment or normal mobile-originated services.",
  "vulnerability_source": "event47 and event42"
}
END_JSON |
...
{
  "vulnerability_detected": "Yes",
  "violated_requirements": [1, 2, 6, 12, 36, 44],
  "explanation": "A UE in RRC_INACTIVE may autonomously reselect to a rogue cell before AS security is established. After the UE sends an RRCResumeRequest, the rogue base station can inject an RRCReject containing a wait time, causing the UE to start T302 and barring normal access categories. By repeatedly attracting the UE and sending RRCReject messages after each retry, the attacker can trap the UE in repeated resume-failure cycles and prevent it from regaining normal service.",
  "issue_classification": "Protocol Design Issue",
  "test_case": "Operate a controlled rogue gNB that advertises a stronger signal and the victim UE's legitimate PLMN. After the UE reselects to the rogue cell and sends RRCResumeRequest, transmit RRCReject with a 16-second wait time after every retry. Verify that the UE repeatedly starts T302, applies access barring, and remains unable to resume service.",
  "vulnerability_source": "event2055 and event1715"
}
...
{
  "vulnerability_detected": "Yes",
  "violated_requirements": [6, 12, 14, 36, 44],
  "explanation": "After a UE in RRC_INACTIVE reselects to a rogue cell and transmits an RRCResumeRequest, the rogue base station can intentionally ignore or blackhole the request instead of completing RRC resumption. The resulting lower-layer resume failure causes the UE to retain the inactive context and apply access barring behavior. Repeated suppression of RRC resumption can keep the UE attached to the rogue cell but unable to access legitimate network services.",
  "issue_classification": "Protocol Design Issue",
  "test_case": "Configure a controlled rogue gNB to advertise a stronger signal and the legitimate PLMN, but intentionally ignore every RRCResumeRequest transmitted by the victim UE. Verify that resumption repeatedly fails and that the UE remains unable to return to normal connected service.",
  "vulnerability_source": "event2055 and event1715"
}
...

{
  "vulnerability_detected": "No",
  "violated_requirements": [],
  "explanation": "The validated RRC RESUME blackhole does not require modification of an in-transit legitimate RRC message. The demonstrated attacker either injects its own RRCReject or ignores the UE's RRCResumeRequest. Although manipulation of RRCReject parameters may represent a separate candidate attack, it is not established by this event connection or the validated proof of concept.",
  "issue_classification": "N/A",
  "test_case": "N/A",
  "vulnerability_source": "unclear"
}
...

{
  "vulnerability_detected": "No",
  "violated_requirements": [],
  "explanation": "The validated attack repeatedly generates new RRCReject responses after successive RRCResumeRequest attempts; it does not replay a previously captured RRCReject. This event connection does not provide sufficient evidence that a stale RRCReject can be accepted outside its corresponding resume attempt or independently restart T302.",
  "issue_classification": "N/A",
  "test_case": "N/A",
  "vulnerability_source": "unclear"
}
